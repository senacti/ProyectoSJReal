...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('hospedajes', function (Blueprint $table) {
            $table->unsignedBigInteger('id_hospedaje', true);
            $table->unsignedBigInteger('hospedaje_id_habitacion')->index('fk_habitacion_has_huesped_habitacion1');
            $table->unsignedBigInteger('hospedaje_id_usuario')->index('fk_hospedaje_usuarios1');
