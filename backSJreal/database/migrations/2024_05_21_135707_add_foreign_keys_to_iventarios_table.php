...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('iventarios', function (Blueprint $table) {
            $table->foreign(['inventario_id_control'], 'fk_Sucursal_has_Inventario_Control_Inventario1')->references(['id_control_inventario'])->on('control_inventarios')->onUpdate('cascade')->onDelete('cascade');
